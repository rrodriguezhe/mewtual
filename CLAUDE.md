...
Cross-app model dependencies flow one direction: `matching` and `adoption` import `cats.models.Cat`; `chat` imports `matching.models.Match`. Keep new cross-app logic following that direction rather than introducing back-references.
